...
# Created by Genus(TM) Synthesis Solution 23.13-s073_1 on Thu Dec 18 18:57:31 UTC 2025

# This file contains the Genus script for design:riscv_core

######################################################################

set_db -quiet init_lib_search_path {  ${libdir}  ${lefdir}  }
...
set_db -quiet runtime_by_stage {{to_generic 294 329 304 343} {first_condense 126 606 53 554} {second_condense 92 703 49 610} {reify 117 820 45 655} {global_incr_map 35 856 32 691} {incr_opt 29 905 33 728} {first_condense 229 1317 109 1037} {PBS_Generic_Opt-Post 1321 1354 1283.7434880000012 1318.445616000001} {{PBS_Generic-Postgen HBO Optimizations} 4 1358 3.0 1321.445616000001} {PBS_TechMap-Start 0 1381 0.0 1345.732903000001} {{PBS_TechMap-Premap HBO Optimizations} 3 1384 4.0 1349.732903000001} {second_condense 139 1527 62 1162} {reify 76 1603 28 1191} {global_incr_map 37 1642 31 1226} {{PBS_Techmap-Global Mapping} 280 1664 260.6178230000014 1610.3507260000024} {{PBS_TechMap-Datapath Postmap Operations} 13 1677 13.235131999999794 1623.5858580000022} {{PBS_TechMap-Postmap HBO Optimizations} 1 1678 0.9456660000000738 1624.5315240000023} {{PBS_TechMap-Postmap Clock Gating} 4 1682 4.0 1628.5315240000023} {{PBS_TechMap-Postmap Cleanup} 1 1683 1.2068540000000212 1629.7383780000023} {PBS_Techmap-Post_MBCI 0 1683 0.0 1629.7383780000023} {incr_opt 63 1759 71 1337} }
...
set_db -quiet hdl_flatten_complex_port true
set_db -quiet hdl_language sv
set_db -quiet hdl_record_naming_style %s_%s
set_db -quiet tinfo_tstamp_file .rs_ziyx.tstamp
set_db -quiet metric_enable true
set_db -quiet design_process_node 7
...
## Written on 18:57:32 18-Dec 2025
#############################################################
#####   Flow Definitions   ##################################
