...
#  Created on Tue Mar 31 09:55:26 2026                
#                                                     
#######################################################
...
place_opt_design -out_dir outputs/innovus/core_hybrid/vcd/reports -prefix place
...
routeDesign
optDesign -postRoute
read_activity_file -format VCD /home/ykaraagac/cadence-bitirme/Flows/NanGate45/biriscv_parallel_matmul/scripts/cadence/outputs/vcd/core_hybrid.vcd -scope tb_parallel_matmul.u_dut
summaryReport -noHtml -outfile outputs/innovus/core_hybrid/vcd/reports/post_route.sum
redirect outputs/innovus/core_hybrid/vcd/reports/power_total.rpt { report_power }
redirect outputs/innovus/core_hybrid/vcd/reports/power_hierarchy.rpt { report_power -hierarchy all }
redirect outputs/innovus/core_hybrid/vcd/reports/power_inst_a.rpt {report_power -instance $REPORT_INST_A}
redirect outputs/innovus/core_hybrid/vcd/reports/power_inst_b.rpt {report_power -instance $REPORT_INST_B}
saveDesign outputs/innovus/core_hybrid/vcd/enc/core_hybrid.enc
defOut -netlist -floorplan -routing outputs/innovus/core_hybrid/vcd/enc/core_hybrid.def
