...
localparam TIMEOUT_CYCLES = 64'd4000000;
...
`ifdef INST_MULEN
              || ((opcode & `INST_MULEN_MASK) == `INST_MULEN)
`endif
`ifdef INST_MULE2
              || ((opcode & `INST_MULE2_MASK) == `INST_MULE2)
`endif
`ifdef INST_MULE2N
              || ((opcode & `INST_MULE2N_MASK) == `INST_MULE2N)
`endif
`ifdef INST_MULE3
              || ((opcode & `INST_MULE3_MASK) == `INST_MULE3)
`endif
`ifdef INST_MULE3N
              || ((opcode & `INST_MULE3N_MASK) == `INST_MULE3N)
`endif
`ifdef INST_MULE5
              || ((opcode & `INST_MULE5_MASK) == `INST_MULE5)
`endif
`ifdef INST_MULE5N
              || ((opcode & `INST_MULE5N_MASK) == `INST_MULE5N)
`endif
`ifdef INST_MULA
              || ((opcode & `INST_MULA_MASK) == `INST_MULA)
`endif
`ifdef INST_MULX
              || ((opcode & `INST_MULX_MASK) == `INST_MULX)
`endif
`ifdef INST_MULB
              || ((opcode & `INST_MULB_MASK) == `INST_MULB)
`endif
`ifdef INST_MULR
              || ((opcode & `INST_MULR_MASK) == `INST_MULR)
`endif
`ifdef INST_MULP
              || ((opcode & `INST_MULP_MASK) == `INST_MULP)
`endif
`ifdef INST_MULC
              || ((opcode & `INST_MULC_MASK) == `INST_MULC)
`endif
              ;
end
endfunction
