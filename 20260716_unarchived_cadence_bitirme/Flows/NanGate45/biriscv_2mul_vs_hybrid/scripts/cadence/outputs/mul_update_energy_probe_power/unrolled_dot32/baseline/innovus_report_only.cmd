...
#  Created on Tue Jun 23 06:06:09 2026                
#                                                     
#######################################################
...
#@ source $ENC_SCRIPT
#@ Begin verbose source /home/ykaraagac/cadence-bitirme/Flows/NanGate45/biriscv_2mul_vs_hybrid/scripts/cadence/outputs/innovus/core_hybrid_mul_update_a04bb61_100/vectorless/enc/core_hybrid_mul_update_a04bb61_100.enc (pre)
if {[is_common_ui_mode]} {
read_db [file dirname [file normalize [info script]]]/core_hybrid_mul_update_a04bb61_100.enc.dat
}
#@ End verbose source /home/ykaraagac/cadence-bitirme/Flows/NanGate45/biriscv_2mul_vs_hybrid/scripts/cadence/outputs/innovus/core_hybrid_mul_update_a04bb61_100/vectorless/enc/core_hybrid_mul_update_a04bb61_100.enc
...
set_switching_activity -clock $VCD_CLOCK_NAME -scale $VCD_CLOCK_SCALE_FACTOR
}
}
